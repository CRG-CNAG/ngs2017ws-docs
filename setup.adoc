...
TIP: You will need the aws command line interface installed to access launch and access the EC2 instance. You can find the details on how to install it here https://aws.amazon.com/cli/[here].
