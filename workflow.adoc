...
http://www.htslib.org/doc/samtools.html[samtools documentation]
https://broadinstitute.github.io/picard/command-line-overview.html[picard documentation]
...
STAR --runMode genomeGenerate \
       ...
       --runThreadN 4
----
http://labshare.cshl.edu/shares/gingeraslab/www-data/dobin/STAR/STAR.posix/doc/STARmanual.pdf[STAR manual]
...
https://vcftools.github.io/man_latest.html[vcftools manual]           
