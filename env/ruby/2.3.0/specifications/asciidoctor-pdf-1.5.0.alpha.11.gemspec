# -*- encoding: utf-8 -*-
# stub: asciidoctor-pdf 1.5.0.alpha.11 ruby lib

Gem::Specification.new do |s|
  s.name = "asciidoctor-pdf"
  s.version = "1.5.0.alpha.11"
  ...
  s.files = ["LICENSE.adoc", "NOTICE.adoc", "README.adoc", "bin/asciidoctor-pdf"]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<prawn-svg>, ["= 0.21.0"])
      s.add_runtime_dependency(%q<prawn-icon>, ["= 1.0.0"])
      ...
      s.add_dependency(%q<prawn-svg>, ["= 0.21.0"])
      s.add_dependency(%q<prawn-icon>, ["= 1.0.0"])
